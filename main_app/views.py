...
try:
    if os.path.exists(model_path):
        ...
        print("Please ensure the trained_model file is in the project root directory.")
except Exception as e:
    print(f"Error loading model: {e}")
    print("The model may be incompatible with the current scikit-learn version.")
    print("You may need to retrain the model with scikit-learn 1.7.2")
     ...
     return render(request,'patient/checkdisease/checkdisease.html', {"list2":alphabaticsymptomslist})
      ...
      if model is None:
          return JsonResponse({
              ...
              'message': 'The disease prediction model is not loaded. Please contact the administrator.',
